...
public class Boys {
    ...
    Boys(String name,double attract,double mb,double iq,int type,double min_attract){
        this.bname=name;
        this.attr_level=attract;
        this.budget=mb;
        this.iq_lvl=iq;
        this.c_type=0;                                    // 0 for non-committed, 1 for miser, 2 for generous, 3 for geek
        this.happy_lvl=0;
